...
- Locate the **Add list item** button. Clicking this button adds a new blank line for entering your list item content.

- Enter the text you want to display for each list item directly in the corresponding line.

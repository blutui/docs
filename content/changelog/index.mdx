...
<Changelog date="2025-12-04" type="Fixed" app="Project Dashboard">
  Fixed an issue where the Project Dashboard login page was being indexed by search engines.
</Changelog>

<Changelog date="2025-11-05" type="Added" app="Project Dashboard">

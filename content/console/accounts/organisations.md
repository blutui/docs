---
title: 'Organisations'
description: 'How organisations work in Blutui'
---
...
- Clients and Content Managers can log into the site by appending /admin\_ to their domain name, for example access to the dashboard of site.com would be via https://site.com/admin
...
<alert markdown="1">
  **Note:** The Dashboard is different from the Agency Console. The Agency Console is the interface you are directed to when you login, whereas the Dashboard needs to be logged into separately. Please see the video below. 
</alert>

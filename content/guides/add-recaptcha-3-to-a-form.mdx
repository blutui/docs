...
Head to your Blutui Dashboard. Click on **Settings** and navigate to **Forms** page.
</Step>

<Step>
### Key configuration
Paste the **Public Key** and **Secret Key** from the reCAPTCHA dashboard into their respective fields in the Blutui Dashboard.
</Step>

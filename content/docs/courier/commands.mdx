...
Create a new Blutui project. In a single command, `create` scaffolds your chosen Canvas into a new directory, initializes Courier (generating the `courier.json` file), and can optionally install [Blutui Context](/docs/getting-started/agentic-development) (MCP server and Skills) to improve AI assisted coding.

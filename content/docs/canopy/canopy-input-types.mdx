...
description: 'Learn about the different Canopy elements available for the Canopy editor in Blutui'
---
...
The following Canopy elements are available for creating editable components in the [Canopy editor](/dashboard/canopy/canopy-overview):

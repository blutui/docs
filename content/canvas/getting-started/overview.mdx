...
**Create a page through the Site Dashboard**: First, create a `layouts` folder inside your `views` directory and add a layout file (e.g., `views/layouts/default.html`). Then, go to the Site Dashboard and create a new page through the **Pages** menu, specifying your layout. The layout path is always relative to the `views/layouts` directory of your project.

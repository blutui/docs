---
title: 'Events Collection Example'
...
```json
{
  ...
  "fields": [
    ...
    },
    {
      ...
      "attribute_name": "registration_url",
      "required": false,
...
**Single file** (`allow_multiple_file_uploads: false`) returns a **string URL**:
...
**Multiple files** (`allow_multiple_file_uploads: true`) returns an **array**:

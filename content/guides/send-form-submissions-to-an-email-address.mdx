...
<Steps>
<Step>
### Navigate to verified emails
Head over to the dashboard. Click on **Settings** and navigate to the **Verified emails** page.
</Step>
...
<Step>
### Link the verified email to a form
Return to the dashboard. Click on **Forms**, then select your desired form and click on the **View form** button located in the top right corner. Insert the verified email address into the **Send submission to** input field in the right sidebar.
</Step>
</Steps>
...
<Steps>
<Step>
### Utilising the 'Reply-To' feature
...
<Step>
### Configuring dynamic submissions

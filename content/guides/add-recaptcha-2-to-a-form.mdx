...
Head to the Dashboard. Click on **Settings** and navigate to **Forms** page.
...
Paste the **Public Key** and **Secret Key** from the reCAPTCHA dashboard into their respective fields in the Dashboard.

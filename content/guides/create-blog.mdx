...
For more information about layouts, read the [How do I create a layout](/guides/create-layout) guide.
...
If you're using the [meta and title tags guide](/guides/add-meta-and-title), you automatically get sensible defaults:

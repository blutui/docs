...
Your machine is ready to build. Head to the [getting started guide](/docs/courier/getting-started#linking-your-project) to link a project, or read the [commands reference](/docs/courier/commands) for everything Courier can do.

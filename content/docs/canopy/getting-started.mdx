...
<Callout>
Canopy elements are **page-specific** — meaning each element's content is tied to the page it appears on. If you need reusable, global content (like a footer or announcement banner), consider using a [Collection](/docs/collections/getting-started) instead.
</Callout>

...
Webhooks can be triggered whenever specific events occur in the Blutui Project. You must have access to the dashboard to create webhooks. For example you can configure a webhook to trigger whenever a form is submitted on a project.
...
Next, copy your webhook URL. From the Dashboard, click the **Settings** page and navigate to **Webhooks**.

...
Webhooks can be triggered whenever specific events occur in your Blutui Project. You must have access to the dashboard to create webhooks. For example you can configure a webhook to trigger whenever a form is submitted on a project.
...
Next, copy your webhook URL. From your Blutui Dashboard, click the **Settings** page and navigate to **Webhooks**.

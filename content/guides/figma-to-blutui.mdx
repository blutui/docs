...
<Callout>
  Depending on your preferred editor, your interface may vary from the screenshot above, which illustrates the workflow
  in VS Code.
</Callout>
...
```
Create this page called "Get on the Burger List" from the selected Figma design using Blutui Canopy Blocks. Generate the page within the Blutui, including placeholder SEO metadata. Finally, build the form using the Blutui form system.
```

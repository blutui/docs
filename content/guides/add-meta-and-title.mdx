...
{% set robots_noindex = (post.is_noindex ?? page.is_noindex ?? false) %}
{% set robots_nofollow = (post.is_nofollow ?? page.is_nofollow ?? false) %}
<meta name="robots" content="{{ robots_noindex ? 'noindex' : 'index' }}, {{ robots_nofollow ? 'nofollow' : 'follow' }}">
...
- [Blocks documentation](/canvas/tags/extends)
- [Include tag documentation](/canvas/tags/include)

...
<section class="bg-slate-900 text-white py-8">
  <div class="mx-auto px-6 text-left space-y-3">
    <h2 class="text-2xl font-semibold tracking-tight sm:text-3xl">Main banner</h2>
  </div>
</section>
```
...
<section class="bg-linear-to-r from-emerald-900 via-emerald-800 to-red-900 text-white py-8">
  <div class="mx-auto px-6 text-left space-y-3">
    <h2 class="text-2xl font-semibold tracking-tight sm:text-3xl text-emerald-50">Merry Christmas & Happy Holidays</h2>
  </div>
</section>
```

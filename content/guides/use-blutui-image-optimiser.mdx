...
For full configuration options, see the [image_url filter documentation](/canvas/filters/image_url).
...
<Cards>
  <Card title="image_url filter documentation" href="/canvas/filters/image_url">

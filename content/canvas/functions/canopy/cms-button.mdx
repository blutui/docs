...
<Callout type="warning">
  This function is part of the deprecated Canopy elements. Use [Canopy Blocks](/docs/canopy/canopy-blocks) to
  build editable sections instead.
</Callout>
...
<Callout>The `opens_new_tab` only works if you are using a `url`.</Callout>
